...
func TestExportCommonJS(t *testing.T) {
	...
	expectedExports := []resultprocessing.Export{
		...
		{"function", "min", []string{}, "commonjs", "constantExport", false, "Number.MIN_VALUE"},
		{"function", "addThree", []string{"a", "b", "c"}, "commonjs", "directExport", true, "addThree"},
		{"function", "default", []string{}, "commonjs", "directExport", true, "foo.subThree"},
		...
		{"function", "e", []string{}, "commonjs", "indirectExport", false, "Math.E"},
